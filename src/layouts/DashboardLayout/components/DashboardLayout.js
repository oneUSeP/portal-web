  ...
  render () {
    ...
    const menu = (
      ...
      {userRole == 'student'
        ...
        : null}
        <Popconfirm title='Are you sure to signout from this session?' onConfirm={this.confirm} onCancel={this.cancel} okText='Yes' cancelText='No'><NavLink className='ant-dropdown-menu-item' activeClassName='ant-dropdown-menu-item-active ant-dropdown-menu-item-selected' key='11'>
          <Icon type='logout' />
